  ...
  return (
    <div className="w-full max-w-1/2 h-auto">
      <form className="flex flex-col gap-y-8">
        ...
        <button type="submit" className="h-full min-h-12 bg-linear-to-l from-violet-600 to-fuchsia-600 rounded-md text-lead-b-d hover:from-violet-900 hover:to-fuchsia-900 transition-colors duration-300">Send</button>
      </form>
    </div>
  );
};
